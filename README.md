...
- `deploy` task to publish and deliver files to remote server
	...
	- [`gulp-surge`](https://github.com/surge-sh/gulp-surge) to deploy to [surge.sh](http://surge.sh/) static page hosting
...
- Pack own JS with [`gulp-include`](https://www.npmjs.com/package/gulp-include)
